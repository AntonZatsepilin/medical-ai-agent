...
КРИТЕРИИ ЗАВЕРШЕНИЯ (Достаточно выполнения большинства):
1. Мы знаем основную жалобу пациента.
2. Мы знаем примерную длительность симптомов.
3. Мы собрали хотя бы 3 значимых факта.
4. ИЛИ если пациент явно сказал "это всё", "больше ничего", "нет".

Если фактов совсем мало (меньше 3) и пациент не отказывается говорить — отвечай "НЕТ".
В остальных случаях, если картина более-менее ясна — отвечай "ДА".
